...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("lastname","Reis");
        request.setParameter("emailAddress","chad_reis@gmail.com");
    }
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("chad_reis@gmail.com");
    ...
    @Test
    public void createAVadilGradeHttpRequestStudentDoesNotExistEmptyResponse() throws Exception {
        MvcResult mvcResult = this.mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade","85.00")
