...
public class StudentAndGradeServiceTest {
    ...
    public void createStudentService() {
        studentService.createStudent("Alp2" , "Taskent" , "alp2@gmail.com");

        CollegeStudent student = studentDao.findByEmailAddress("alp2@gmail.com");

        assertEquals("alp2@gmail.com", student.getEmailAddress(),"find by email");
    }
    ...
    @Test
    public void createGradeServicec() {
        // Create the grade
