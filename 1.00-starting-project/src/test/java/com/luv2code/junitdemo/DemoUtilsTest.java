...
//@DisplayNameGeneration(DisplayNameGenerator.IndicativeSentences.class) // simple , underscore
...
class DemoUtilsTest {
    ...
    void testSameAndNotSame() {
        String str = "luv2code";
        assertSame(demoUtils.getAcademy(), demoUtils.getAcademyDuplicate(), "Objects should refer to the same");
